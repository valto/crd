...
2. Which part of the model it affects: capability, interaction contract, realization, semantics, schema, or agent transformation.
3. Why the change belongs in the mandatory core, an optional extension, or a non-normative example.
4. Any compatibility impact on existing documents or structured instances.
